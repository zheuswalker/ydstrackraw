...
var closest_1 = require("../utils/closest");
...
var Framework = /** @class */ (function (_super) {
    ...
    Framework.prototype.onIconPlaced = function (e) { }; // tslint:disable-line:no-empty
    ...
    Framework.prototype.onElementValidated = function (e) {
        ...
        var type = e.element.getAttribute('type');
        var element = ('radio' === type || 'checkbox' === type) ? elements[0] : e.element;
        (0, classSet_1.default)(element, (_a = {},
        ...
        if (groupEle) {
            if (!e.valid) {
                ...
                if (isValid_1) {
                    (0, classSet_1.default)(groupEle, (_c = {},
